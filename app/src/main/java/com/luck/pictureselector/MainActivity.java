        ...
        public void onAddPicClick() {
            ...
            if (mode) {
                ...
                PictureSelector.create(MainActivity.this)
                        ...
                        .queryMaxFileSizeDisplay(false)//是否显示超出限定值的内容
                        .queryMaxFileSizeToVideo(2)// 只查多少M以内的图片、视频、音频  单位M
                        .queryMaxFileSizeToImage(1)// 只查多少M以内的图片、视频、音频  单位M
...
//                        .setCompressionFormat()
                        .cutCompressionFormat(Bitmap.CompressFormat.PNG)
...
//                        .videoSecondDisplay(true) //是否显示超出限定值的内容
//                        .videoMinSecond(1)// 查询多少秒以内的视频
//                        .videoMaxSecond(3)// 查询多少秒以内的视频
